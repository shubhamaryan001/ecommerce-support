...
export class MessageComponent implements OnInit, AfterViewInit {
  ...
  GetMessages(senderId, receiverId) {
    this.msgService.GetAllMessages(this.token,senderId, receiverId).then(data => {
  ...
  SendMessage() {
    if (this.message) {
      this.msgService.SendMessage(this.token, this.senderPostId, this.senderName, this.receiverData, this.receiverName, this.message).then(data => {
